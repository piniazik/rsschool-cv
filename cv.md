...
&nbsp;&nbsp;&nbsp;**E-mail:** 
[![N|Solid](https://img.icons8.com/officexs/2x/mail-contact.png)](brutto33@tut.by)
&nbsp;&nbsp;&nbsp;**Linkedin:** 
...
```
- JavaScript (examples of my code)
- HTML5
- CSS3(Animation)
- Bootstrap(5)
- Photoshop
...
### Nov. 2019 – Present MILTIM LLC (ONLINE STORE)

Content Manager, HTML-coder

**Location:** Minsk

Work with goods using Bitrix. Adding photos and attributes using Jumper.
...
### July 2018 – sept. 2019 (1 year 3 months) SOBDOORS (ONLINE STORE)

Content Manager, HTML-coder

**Location:** Minsk

Work with Wordpress, with the WooCommrce plugin. Adding products, adjusting photos, attributes and prices of goods. Work on changing the wordpress theme.
...
I've already been studying English with a tutor for 1 year and 3 months.
...
Date of issue: apr. 2019 Open file
